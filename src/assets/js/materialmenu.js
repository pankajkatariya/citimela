        ...
        var MaterialMenu = function (element, options) {
            ...
            this.prepare = function () {
                ...
                if (this.options.showTitle)
                {
                    ...
                    if (title.length == 0)
                    {
                        $('<div />', {'class': 'material-menu-titlebar', 'style': 'display:block;position:fixed;left:0px;top:0px;width:100%;height:50px;;background-color:#f55100;z-index:11;'}).appendTo('body');

                        // Get title element
                        this.title = $('.material-menu-titlebar');

                        // Add menu button
                        this.title.append($(this.options.buttonHTML).addClass(this.options.buttonClass).css({'float': 'right', 'margin': '0px'}));
                ...
                {
                    $('<div />', {'class': 'material-menu-overlay', 'style': 'display:block;position:fixed;left:0px;top:0px;width:100%;height:100%;z-index:1;background-color:#000000;'}).appendTo('body');
